...
object Dependencies {
  ...
  private val awsUtilsVersion = "0.1.204"
  private val elasticMqVersion = "1.6.8"
  ...
  lazy val transformSchemas = "uk.gov.nationalarchives" % "da-transform-schemas" % "2.11-SNAPSHOT"
  lazy val notifyJavaClient = "uk.gov.service.notify" % "notifications-java-client" % "5.2.0-RELEASE"
}
