...
object Dependencies {
  ...
  private val awsUtilsVersion = "0.1.205"
  private val elasticMqVersion = "1.6.6"
  ...
  lazy val transformSchemas = "uk.gov.nationalarchives" % "da-transform-schemas" % "2.9-SNAPSHOT"
